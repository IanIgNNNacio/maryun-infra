...
# Complejidad de contraseña. Flask-AppBuilder 5 la valida al crear la cuenta y
# al cambiarla; por defecto no valida NADA, así que servía cualquier cadena.
# Mientras esto solo se alcanzaba por la VPN era discutible; desde que
# superset.maryun.cl resuelve a la IP pública y la pantalla de acceso la ve
# cualquiera, no.
#
# OJO: no invalida las contraseñas que ya existen. Solo se aplica a las nuevas y
# a los cambios, así que hay que pedir el cambio a quien tenga una débil.
